    ...
    <section className="relative py-24 md:py-36 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-page max-w-4xl">
        <RevealOnScroll>
          ...
          <h3 className="cormorant text-4xl md:text-6xl text-white mb-8 drop-shadow-md">"A ritual of rest."</h3>
          ...
          <Link href="/collections" className="inline-block">
            <Button variant="auth-primary" className="!w-auto px-10 uppercase tracking-[0.1em] text-sm">
              The ZIEA Promise
            </Button>
          </Link>
        </RevealOnScroll>
