  ...
  return (
    <section className="px-page">
      <div className="bg-primary/20 rounded-3xl px-8 py-8 md:px-16 md:py-10 flex flex-col items-center text-center space-y-6 md:space-y-8 relative overflow-hidden">
        ...
        />
        <h3 className="cormorant text-4xl md:text-6xl text-primary-dark font-light">Our Story</h3>
        <div className="space-y-5 md:space-y-6 max-w-2xl mx-auto">
          ...
          <div className="pt-2 space-y-3">
            <h4 className="cormorant text-2xl md:text-4xl text-primary-dark font-light">Who We Are</h4>
            <p className="text-text leading-relaxed text-lg md:text-xl">
        ...
        <Link
          href="/about-us"
          className="inline-flex items-center gap-2 text-primary font-semibold text-lg md:text-xl hover:gap-3 transition-all"
        >
          Read More
